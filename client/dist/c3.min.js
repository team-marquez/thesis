...
!(function(t, e) {
    "object" == typeof exports && "undefined" != typeof module
      ? (module.exports = e())
      : "function" == typeof define && define.amd ? define(e) : (t.c3 = e());
  })(this, function() {
    "use strict";
    function u(t) {
      var e = this;
      (e.d3 = window.d3
        ? window.d3
        : "undefined" != typeof require ? require("d3") : void 0),
        (e.api = t),
    ...
    function n(t) {
      var e = (this.internal = new u(this));
      e.loadConfig(t),
        e.beforeInit(t),
        e.init(),
        e.afterInit(t),
      ...
      (i.prototype.splitTickText = function(t, e) {
        ...
        return (
          (!c || c <= 0) &&
            (c = s.isVertical()
              ? 95
              : s.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110),
          (function t(e, i) {
            a = void 0;
    ...
    (d.prototype.init = function() {
      ...
      (d.prototype.getXAxis = function(t, e, i, n, r, a, o) {
        ...
        return (
          ...
          s.isCategorized() &&
            ...
            l(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
          u
        );
      }),
      ...
      (d.prototype.getLabelPosition = function(t, e) {
        var i = this.getLabelOptionByAxisId(t),
          n =
            i && "object" === (void 0 === i ? "undefined" : s(i)) && i.position
              ? i.position
              : e;
        return {
      ...
      (d.prototype.xForAxisLabel = function(t, e) {
        var i = this.owner;
        return t
          ? e.isLeft ? 0 : e.isCenter ? i.width / 2 : i.width
          : e.isBottom ? -i.height : e.isMiddle ? -i.height / 2 : 0;
      }),
      (d.prototype.dxForAxisLabel = function(t, e) {
        return t
          ? e.isLeft ? "0.5em" : e.isRight ? "-0.5em" : "0"
          : e.isTop ? "-0.5em" : e.isBottom ? "0.5em" : "0";
      }),
      (d.prototype.textAnchorForAxisLabel = function(t, e) {
        return t
          ? e.isLeft ? "start" : e.isCenter ? "middle" : "end"
          : e.isBottom ? "start" : e.isMiddle ? "middle" : "end";
      }),
      ...
      (d.prototype.dyForXAxisLabel = function() {
        ...
        return e.axis_rotated
          ...
          : i.isInner ? "-0.5em" : e.axis_x_height ? e.axis_x_height - 10 : "3em";
      }),
      ...
      (d.prototype.getPadding = function(t, e, i, n) {
        ...
        return P(r)
          ? "ratio" === t.unit ? t[e] * n : this.convertPixelsToAxisPadding(r, n)
          : i;
      }),
        ...
        if (e)
          if (1 === (n = h(e) ? e() : e)) u = [t[0]];
            ...
            for (
              ...
              (d = +r + s * (c + 1)), u.push(i ? new Date(d) : d);
            u.push(a);
          }
        return (
          i ||
    ...
    return (
      (u.prototype.beforeInit = function() {}),
      ...
      (u.prototype.initParams = function() {
        ...
        (t.clipId = "c3-" + +new Date() + "-clip"),
          ...
          (t.xOrient = i.axis_rotated
            ? i.axis_x_inner ? "right" : "left"
            : i.axis_x_inner ? "top" : "bottom"),
          (t.yOrient = i.axis_rotated
            ? i.axis_y_inner ? "top" : "bottom"
            : i.axis_y_inner ? "right" : "left"),
          (t.y2Orient = i.axis_rotated
            ? i.axis_y2_inner ? "bottom" : "top"
            : i.axis_y2_inner ? "left" : "right"),
      ...
      (u.prototype.initChartElements = function() {
      ...
      (u.prototype.initWithData = function(t) {
        var e,
          i,
          n = this,
          r = n.d3,
      ...
      (u.prototype.smoothLines = function(t, e) {
        var a = this;
        "grid" === e &&
          t.each(function() {
      ...
      (u.prototype.updateSizes = function() {
        var t = this,
          e = t.config,
      ...
      (u.prototype.updateTargets = function(t) {
        var e = this;
      ...
      (u.prototype.showTargets = function() {
        var e = this;
        e.svg
          .selectAll("." + Y.target)
          .filter(function(t) {
      ...
      (u.prototype.redraw = function(t, e) {
        var i,
          n,
          r,
          a,
      ...
      (u.prototype.updateAndRedraw = function(t) {
        var e,
          i = this,
          n = i.config;
      ...
      (u.prototype.redrawWithoutRescale = function() {
        this.redraw({
          withY: !1,
          withSubchart: !1,
          withEventRect: !1,
      ...
      (u.prototype.initialOpacity = function(t) {
        return null !== t.value && this.withoutFadeIn[t.id] ? 1 : 0;
      }),
      (u.prototype.initialOpacityForCircle = function(t) {
        return null !== t.value && this.withoutFadeIn[t.id]
          ? this.opacityForCircle(t)
          : 0;
      }),
      (u.prototype.opacityForCircle = function(t) {
        var e = (h(this.config.point_show)
      ...
      (u.prototype.opacityForText = function() {
        return this.hasDataLabel() ? 1 : 0;
      }),
      (u.prototype.xx = function(t) {
        return t ? this.x(t.x) : null;
      }),
      (u.prototype.xv = function(t) {
        var e = this,
          i = t.value;
        return (
          e.isTimeSeries()
      ...
      (u.prototype.yv = function(t) {
        var e = t.axis && "y2" === t.axis ? this.y2 : this.y;
        return Math.ceil(e(t.value));
      }),
      (u.prototype.subxx = function(t) {
        return t ? this.subX(t.x) : null;
      }),
      (u.prototype.transformMain = function(t, e) {
        var i,
          n,
          r,
          a = this;
      ...
      (u.prototype.updateDimension = function(t) {
        var e = this;
        t ||
      ...
      (u.prototype.observeInserted = function(e) {
        var i,
          n = this;
      ...
      (u.prototype.generateResize = function() {
        var i = [];
        function t() {
      ...
      (u.prototype.endall = function(t, e) {
        var i = 0;
        t
          .each(function() {
            ++i;
      ...
      (u.prototype.generateWait = function() {
        var n = [],
          t = function(t) {
      ...
      (u.prototype.parseDate = function(t) {
        var e;
        return (
          t instanceof Date
            ? (e = t)
      ...
      (u.prototype.isTabVisible = function() {
        var t;
        return (
      ...
      (u.prototype.generateFlow = function(E) {
        var I = this,
          O = I.config,
          R = I.d3;
        return function() {
          ...
          (I.flowing = !0),
            ...
            (i = I.updateXDomain(l, !0, !0)),
            I.updateXGrid && I.updateXGrid(!0),
            (n = I.xgrid || R.selectAll([])),
            (r = I.xgridLines || R.selectAll([])),
            (a = I.mainRegion || R.selectAll([])),
            (o = I.mainText || R.selectAll([])),
            (s = I.mainBar || R.selectAll([])),
            (c = I.mainLine || R.selectAll([])),
            (d = I.mainArea || R.selectAll([])),
            (u = I.mainCircle || R.selectAll([])),
            h.orgDataCount
              ? (t =
                  1 === h.orgDataCount || (A && A.x) === (T && T.x)
                    ...
                    : I.isTimeSeries()
                      ? I.x(P[0]) - I.x(i[0])
                      : I.x(A.x) - I.x(T.x))
              : 1 !== I.data.targets[0].values.length
                ? (t = I.x(P[0]) - I.x(i[0]))
                : I.isTimeSeries()
                  ? ((A = I.getValueOnIndex(I.data.targets[0].values, 0)),
                    (T = I.getValueOnIndex(
                      I.data.targets[0].values,
                      I.data.targets[0].values.length - 1
                    )),
                    (t = I.x(A.x) - I.x(T.x)))
                  : (t = k(i) / 2),
            (e = "translate(" + t + ",0) scale(" + k(P) / k(i) + ",1)"),
            I.hideXGridFocus();
          var G = R.transition()
            .ease(R.easeLinear)
            .duration(C);
          V.add(I.xAxis(I.axes.x, G)),
            ...
            V.add(r.transition(G).attr("transform", e)),
            V(function() {
              var t,
                e = [],
                i = [];
              if (b) {
                ...
                I.svg
                  ...
                  I.svg
                    ...
                    .selectAll(i)
                    .remove(),
                  I.svg.select("." + Y.xgrid).remove();
              }
              n
                .attr("transform", null)
                .attr("x1", I.xgridAttr.x1)
                .attr("x2", I.xgridAttr.x2)
                .attr("y1", I.xgridAttr.y1)
                .attr("y2", I.xgridAttr.y2)
                .style("opacity", I.xgridAttr.opacity),
                r.attr("transform", null),
                r
                  .select("line")
                  .attr("x1", O.axis_rotated ? 0 : y)
                  .attr("x2", O.axis_rotated ? I.width : y),
                r
                  .select("text")
                  .attr("x", O.axis_rotated ? I.width : 0)
                  .attr("y", y),
                s.attr("transform", null).attr("d", g),
                c.attr("transform", null).attr("d", p),
                d.attr("transform", null).attr("d", f),
                u
                  .attr("transform", null)
                  .attr("cx", _)
                  .attr("cy", x),
      ...
      (n.prototype.select = function(c, d, u) {
        var l = this.internal,
          h = l.d3,
          g = l.config;
            ...
            .each(function(t, e) {
              ...
              i.classed(Y.line) ||
                ...
                (a && o
                  ...
                  : D(u) && u && s && r(!1, i.classed(Y.SELECTED, !1), t, e));
            });
      }),
      ...
      (u.prototype.transformTo = function(t, e, i) {
        var n = this,
          r = !n.hasArcType(),
      ...
      (u.prototype.updateRadius = function() {
        var t = this,
          e = t.config,
        ...
        (t.radiusExpanded =
          Math.min(t.arcWidth, t.arcHeight) /
          2 *
      ...
      (u.prototype.getSvgArc = function() {
        var n = this,
          e = n.hasType("gauge"),
      ...
      (u.prototype.getSvgArcExpanded = function(e) {
        e = e || 1;
        var i = this,
          n = i.hasType("gauge"),
      ...
      (u.prototype.getArc = function(t, e, i) {
        return i || this.isArcType(t.data) ? this.svgArc(t, e) : "M 0 0";
      }),
      (u.prototype.transformForArcLabel = function(t) {
        var e,
          i,
          n,
          r,
      ...
      (u.prototype.textForArcLabel = function(t) {
        var e,
          i,
          n,
          r,
      ...
      (u.prototype.textForGaugeMinMax = function(t, e) {
        var i = this.getGaugeLabelExtents();
        return i ? i(t, e) : t;
      }),
      (u.prototype.expandArc = function(t) {
        var e,
          i = this;
        i.transiting
      ...
      (u.prototype.unexpandArc = function(t) {
        var e = this;
        e.transiting ||
          ((t = e.mapToTargetIds(t)),
          e.svg
      ...
      (u.prototype.expandDuration = function(t) {
        var e = this.config;
        return this.isDonutType(t)
          ? e.donut_expand_duration
          : this.isGaugeType(t)
            ? e.gauge_expand_duration
            : this.isPieType(t) ? e.pie_expand_duration : 50;
      }),
      (u.prototype.shouldExpand = function(t) {
        var e = this.config;
        return (
      ...
      (u.prototype.shouldShowArcLabel = function() {
        var t = this.config,
          e = !0;
        return (
          this.hasType("donut")
      ...
      (u.prototype.meetsArcLabelThreshold = function(t) {
        var e = this.config;
        return (
          (this.hasType("donut")
      ...
      (u.prototype.getArcLabelFormat = function() {
        var t = this.config,
      ...
      (u.prototype.getGaugeLabelExtents = function() {
        return this.config.gauge_label_extents;
      }),
      (u.prototype.getArcTitle = function() {
        return this.hasType("donut") ? this.config.donut_title : "";
      }),
      (u.prototype.updateTargetsForArc = function(t) {
        var e,
          i = this,
          n = i.main,
      ...
      (u.prototype.redrawArc = function(t, e, i) {
        var n,
          r,
          a,
          o,
        ...
        if (
          ((r = (n = d
            ...
            .style("cursor", function(t) {
              return c.interaction_enabled && c.data_selection_isselectable(t)
                ? "pointer"
                : null;
            })
            .each(function(t) {
          ...
          h &&
            ...
            1 === u.filterTargetsToShow(u.data.targets).length
              ...
              : s
                  ...
                  .style("display", c.gauge_labelLine_show ? "" : "none")
                  .each(function(t) {
                    var e = 0,
                      i = 0,
                      n = 0,
                    ...
                    if (u.hiddenTargetIds.indexOf(t.data.id) < 0) {
                      var a = u.updateAngle(t),
                        o =
                          u.gaugeArcWidth /
                          u.filterTargetsToShow(u.data.targets).length *
                          (a.index + 1),
                        s = a.endAngle - Math.PI / 2,
                        c = u.radius - o,
                        d = s - (0 === c ? 0 : 1 / c);
                      (e = u.radiusExpanded - u.radius + o),
                        (i = Math.cos(d) * c),
                        (n = Math.sin(d) * c),
                        (r =
                          "rotate(" +
              ...
              c.interaction_enabled
                ? function(t, e) {
                    ...
                    n &&
                      ...
                      u.toggleShape && u.toggleShape(this, i, e),
                      u.config.data_onclick.call(u.api, i, this));
                  }
                : null
            )
            .each(function() {
          ...
          (a = u.arcs
            ...
            .attr("d", function(t) {
              ...
              var e = {
                ...
                endAngle:
                  -1 * c.gauge_startingAngle * (c.gauge_fullCircle ? Math.PI : 1),
                index: g++
              };
            ...
            u.arcs
              ...
              .attr(
                ...
                -1 *
                  (u.innerRadius +
                    (u.radius - u.innerRadius) / (c.gauge_fullCircle ? 1 : 2)) +
                  "px"
              )
              .attr("dy", "1.2em")
              .text(
                c.gauge_label_show ? u.textForGaugeMinMax(c.gauge_min, !1) : ""
              ),
            u.arcs
              ...
              .attr("dy", "1.2em")
              .text(
                c.gauge_label_show ? u.textForGaugeMinMax(c.gauge_max, !0) : ""
              );
        }
      }),
      (u.prototype.initGauge = function() {
        var t = this.arcs;
        this.hasType("gauge") &&
      ...
      (u.prototype.getGaugeLabelHeight = function() {
        return this.config.gauge_label_show ? 20 : 0;
      }),
      (u.prototype.hasCaches = function(t) {
        for (var e = 0; e < t.length; e++) if (!(t[e] in this.cache)) return !1;
        return !0;
      }),
      (u.prototype.addCache = function(t, e) {
        this.cache[t] = this.cloneTarget(e);
      }),
      (u.prototype.getCaches = function(t) {
        var e,
          i = [];
      ...
      (u.prototype.selectorLegend = function(t) {
        return "." + Y.legendItem + this.getTargetSelectorSuffix(t);
      }),
      (u.prototype.selectorLegends = function(t) {
        var e = this;
        return t && t.length
          ? t.map(function(t) {
      ...
      (u.prototype.getClipPath = function(t) {
        return (
          "url(" +
      ...
      (u.prototype.generateLevelColor = function() {
        var t = this.config,
          n = t.color_pattern,
          e = t.color_threshold,
          r = "value" === e.unit,
      ...
      (u.prototype.getDefaultConfig = function() {
        var e = {
          bindto: "#chart",
      ...
      (u.prototype.convertUrlToData = function(t, e, i, n, r) {
        var a,
          o,
          s = this,
          c = e || "csv";
        "json" === c
          ? ((a = s.d3.json), (o = s.convertJsonToData))
          : ((a = "tsv" === c ? s.d3.tsv : s.d3.csv), (o = s.convertXsvToData)),
          a(t, i)
            .then(function(t) {
      ...
      (u.prototype.convertXsvToData = function(t) {
        var e = t.columns;
        return 0 === t.length
          ? {
              keys: e,
      ...
      (u.prototype.convertJsonToData = function(e, t) {
        var r,
          i,
          a = this,
          o = [];
        return (
          t
            ? (t.x
              ...
              (i = a.convertRowsToData(o)))
            : (Object.keys(e).forEach(function(t) {
                o.push([t].concat(e[t]));
              }),
              (i = a.convertColumnsToData(o))),
          i
        );
      }),
      (u.prototype.findValueInJson = function(t, e) {
        for (
      ...
      (u.prototype.convertRowsToData = function(t) {
      ...
      (u.prototype.convertColumnsToData = function(t) {
      ...
      (u.prototype.convertDataToTargets = function(t, n) {
        var e,
          i,
          r,
          a,
      ...
      (u.prototype.isNotX = function(t) {
        return !this.isX(t);
      }),
      (u.prototype.getXKey = function(t) {
        var e = this.config;
        return e.data_x ? e.data_x : C(e.data_xs) ? e.data_xs[t] : null;
      }),
      (u.prototype.getXValuesOfXKey = function(e, t) {
        var i,
          n = this;
        return (
      ...
      (u.prototype.getValueOnIndex = function(t, e) {
        var i = t.filter(function(t) {
          return t.index === e;
        });
        return i.length ? i[0] : null;
      }),
      (u.prototype.updateTargetX = function(t, n) {
        var r = this;
      ...
      (u.prototype.updateTargetXs = function(t, e) {
        var i = this;
        t.forEach(function(t) {
          e[t.id] && i.updateTargetX([t], e[t.id]);
        });
      }),
      (u.prototype.generateTargetX = function(t, e, i) {
        var n = this;
        return n.isTimeSeries()
          ? t ? n.parseDate(t) : n.parseDate(n.getXValue(e, i))
          : n.isCustomX() && !n.isCategorized()
            ? P(t) ? +t : n.getXValue(e, i)
            : i;
      }),
      (u.prototype.cloneTarget = function(t) {
        return {
          id: t.id,
          id_org: t.id_org,
      ...
      (u.prototype.getMaxDataCount = function() {
        return this.d3.max(this.data.targets, function(t) {
          return t.values.length;
        });
      }),
      (u.prototype.mapToIds = function(t) {
        return t.map(function(t) {
          return t.id;
        });
      }),
      (u.prototype.mapToTargetIds = function(t) {
        return t ? [].concat(t) : this.mapToIds(this.data.targets);
      }),
      (u.prototype.hasTarget = function(t, e) {
        var i,
          n = this.mapToIds(t);
        for (i = 0; i < n.length; i++) if (n[i] === e) return !0;
        return !1;
      }),
      (u.prototype.isTargetToShow = function(t) {
        return this.hiddenTargetIds.indexOf(t) < 0;
      }),
      (u.prototype.isLegendToShow = function(t) {
        return this.hiddenLegendIds.indexOf(t) < 0;
      }),
      (u.prototype.filterTargetsToShow = function(t) {
        var e = this;
        return t.filter(function(t) {
          return e.isTargetToShow(t.id);
        });
      }),
      (u.prototype.mapTargetsToUniqueXs = function(t) {
        var e = this.d3
          .set(
            this.d3.merge(
              t.map(function(t) {
      ...
      (u.prototype.addHiddenTargetIds = function(t) {
      ...
      (u.prototype.checkValueInTargets = function(t, e) {
        var i,
          n,
          r,
          a = Object.keys(t);
      ...
      (u.prototype.hasNegativeValueInTargets = function(t) {
        return this.checkValueInTargets(t, function(t) {
          return t < 0;
        });
      }),
      (u.prototype.hasPositiveValueInTargets = function(t) {
        return this.checkValueInTargets(t, function(t) {
          return 0 < t;
        });
      }),
      (u.prototype.isOrderDesc = function() {
        var t = this.config;
        return (
          "string" == typeof t.data_order && "desc" === t.data_order.toLowerCase()
        );
      }),
      (u.prototype.isOrderAsc = function() {
        var t = this.config;
        return (
          "string" == typeof t.data_order && "asc" === t.data_order.toLowerCase()
        );
      }),
      (u.prototype.getOrderFunction = function() {
        var t = this.config,
          r = this.isOrderAsc(),
          e = this.isOrderDesc();
        if (r || e) {
      ...
      (u.prototype.orderTargets = function(t) {
        var e = this.getOrderFunction();
        return e && t.sort(e), t;
      }),
      (u.prototype.filterByX = function(t, e) {
        return this.d3
          .merge(
            t.map(function(t) {
              return t.values;
      ...
      (u.prototype.filterRemoveNull = function(t) {
        return t.filter(function(t) {
          return P(t.value);
        });
      }),
      (u.prototype.filterByXDomain = function(t, e) {
        return t.map(function(t) {
          return {
            id: t.id,
            id_org: t.id_org,
      ...
      (u.prototype.hasDataLabel = function() {
        var t = this.config;
        return (
      ...
      (u.prototype.getDataLabelLength = function(t, e, i) {
        var n = this,
          r = [0, 0];
        return (
          n.selectChart
      ...
      (u.prototype.isNoneArc = function(t) {
        return this.hasTarget(this.data.targets, t.id);
      }),
      (u.prototype.isArc = function(t) {
        return "data" in t && this.hasTarget(this.data.targets, t.data.id);
      }),
      (u.prototype.findClosestFromTargets = function(t, e) {
        var i,
          n = this;
        return (
          (i = t.map(function(t) {
      ...
      (u.prototype.findClosest = function(t, i) {
        var n,
          r = this,
      ...
      (u.prototype.convertValuesToStep = function(t) {
        var e,
          i = [].concat(t);
      ...
      (u.prototype.updateDataAttributes = function(t, e) {
      ...
      (u.prototype.loadFromArgs = function(e) {
        var i = this;
        e.data
          ? i.load(i.convertDataToTargets(e.data), e)
          : e.url
            ? i.convertUrlToData(e.url, e.mimeType, e.headers, e.keys, function(
                t
              ) {
      ...
      (u.prototype.unload = function(t, e) {
        var i = this;
        e || (e = function() {}),
      ...
      (u.prototype.getYDomainMin = function(t) {
        var e,
          i,
          n,
          r,
      ...
      (u.prototype.getYDomainMax = function(t) {
        var e,
          i,
          n,
          r,
      ...
      (u.prototype.getYDomain = function(t, e, i) {
        var n,
          r,
          a,
          o,
      ...
      (u.prototype.getXDomainMin = function(t) {
        var e = this,
          i = e.config;
        return D(i.axis_x_min)
          ? e.isTimeSeries() ? this.parseDate(i.axis_x_min) : i.axis_x_min
      ...
      (u.prototype.getXDomainMax = function(t) {
        var e = this,
          i = e.config;
        return D(i.axis_x_max)
          ? e.isTimeSeries() ? this.parseDate(i.axis_x_max) : i.axis_x_max
      ...
      (u.prototype.getXDomainPadding = function(t) {
        var e,
          i,
          n,
          r,
        ...
        return (
          (i = this.isCategorized()
            ? 0
            : this.hasType("bar")
              ? 1 < (e = this.getMaxDataCount()) ? o / (e - 1) / 2 : 0.5
              : 0.01 * o),
      ...
      (u.prototype.getXDomain = function(t) {
        var e = this,
      ...
      (u.prototype.updateXDomain = function(t, e, i, n, r) {
        var a = this,
          o = a.config;
        return (
          i &&
      ...
      (u.prototype.trimXDomain = function(t) {
      ...
      (u.prototype.dragstart = function(t) {
        var e = this,
          i = e.config;
        e.hasArcType() ||
      ...
      (u.prototype.getYFormat = function(t) {
        var n = this,
      ...
      (u.prototype.yFormat = function(t) {
        var e = this.config;
        return (e.axis_y_tick_format
          ? e.axis_y_tick_format
          : this.defaultValueFormat)(t);
      }),
      (u.prototype.y2Format = function(t) {
        var e = this.config;
        return (e.axis_y2_tick_format
          ? e.axis_y2_tick_format
          : this.defaultValueFormat)(t);
      }),
      (u.prototype.defaultValueFormat = function(t) {
        return P(t) ? +t : "";
      }),
      (u.prototype.defaultArcValueFormat = function(t, e) {
        return (100 * e).toFixed(1) + "%";
      }),
      (u.prototype.dataLabelFormat = function(t) {
        ...
        return "function" == typeof e.format
          ...
          : "object" === s(e.format)
            ? e.format[t]
              ? !0 === e.format[t] ? i : e.format[t]
              : function() {
                  return "";
                }
            : i;
      }),
      (u.prototype.initGrid = function() {
        var t = this,
          e = t.config,
          i = t.d3;
        (t.grid = t.main
      ...
      (u.prototype.initGridLines = function() {
        var t = this,
          e = t.d3;
        (t.gridLines = t.main
          .append("g")
      ...
      (u.prototype.updateXGrid = function(t) {
        var e = this,
          i = e.config,
          n = e.d3,
      ...
      (u.prototype.updateYGrid = function() {
        var t = this,
          e = t.config,
      ...
      (u.prototype.gridTextAnchor = function(t) {
        return t.position ? t.position : "end";
      }),
      (u.prototype.gridTextDx = function(t) {
        return "start" === t.position ? 4 : "middle" === t.position ? 0 : -4;
      }),
      (u.prototype.xGridTextX = function(t) {
        return "start" === t.position
          ? -this.height
          : "middle" === t.position ? -this.height / 2 : 0;
      }),
      (u.prototype.yGridTextX = function(t) {
        return "start" === t.position
          ? 0
          : "middle" === t.position ? this.width / 2 : this.width;
      }),
      (u.prototype.updateGrid = function(t) {
        var e,
          i,
          n,
          r,
          ...
          c = a.xv.bind(a),
          d = a.yv.bind(a),
          u = a.xGridTextX.bind(a),
          l = a.yGridTextX.bind(a);
      ...
      (u.prototype.redrawGrid = function(t, e) {
        var i = this,
          n = i.config,
          r = i.xv.bind(i),
      ...
      (u.prototype.showXGridFocus = function(t) {
        var e = this,
          i = e.config,
      ...
      (u.prototype.hideXGridFocus = function() {
        this.main.select("line." + Y.xgridFocus).style("visibility", "hidden");
      }),
      (u.prototype.updateXgridFocus = function() {
        var t = this.config;
        this.main
      ...
      (u.prototype.generateGridData = function(t, e) {
        var i,
          n,
          r,
          a,
      ...
      (u.prototype.getGridFilterToRemove = function(t) {
        return t
          ? function(e) {
              var i = !1;
              return (
      ...
      (u.prototype.removeGridLines = function(t, e) {
        var i = this.config,
      ...
      (u.prototype.initEventRect = function() {
        var t = this,
          e = t.config;
        t.main
          .select("." + Y.chart)
      ...
      (u.prototype.redrawEventRect = function() {
        var t,
          e,
          r = this,
          a = r.d3,
      ...
      (u.prototype.getMousePosition = function(t) {
        return [this.x(t.x), this.getYScale(t.id)(t.value)];
      }),
      (u.prototype.dispatchEvent = function(t, e) {
        var i = "." + Y.eventRect,
      ...
      (u.prototype.initLegend = function() {
        var t = this;
        if (
          ((t.legendItemTextBox = {}),
      ...
      (u.prototype.updateLegendWithDefaults = function() {
      ...
      (u.prototype.updateSizeForLegend = function(t, e) {
        var i = this,
          n = i.config,
          r = {
            top: i.isLegendTop
        ...
        i.margin3 = {
          top: i.isLegendRight
            ? 0
            : i.isLegendInset ? r.top : i.currentHeight - t,
          right: NaN,
          bottom: 0,
          left: i.isLegendRight
            ? i.currentWidth - e
            : i.isLegendInset ? r.left : 0
        };
      }),
      (u.prototype.transformLegend = function(t) {
        (t ? this.legend.transition() : this.legend).attr(
          "transform",
          this.getTranslate("legend")
        );
      }),
      (u.prototype.updateLegendStep = function(t) {
        this.legendStep = t;
      }),
      (u.prototype.updateLegendItemWidth = function(t) {
        this.legendItemWidth = t;
      }),
      (u.prototype.updateLegendItemHeight = function(t) {
        this.legendItemHeight = t;
      }),
      (u.prototype.getLegendWidth = function() {
        var t = this;
      ...
      (u.prototype.getLegendHeight = function() {
        var t = this,
          e = 0;
        return (
          t.config.legend_show &&
      ...
      (u.prototype.opacityForLegend = function(t) {
        return t.classed(Y.legendItemHidden) ? null : 1;
      }),
      (u.prototype.opacityForUnfocusedLegend = function(t) {
        return t.classed(Y.legendItemHidden) ? null : 0.3;
      }),
      (u.prototype.toggleFocusLegend = function(e, t) {
        var i = this;
        (e = i.mapToTargetIds(e)),
          i.legend
      ...
      (u.prototype.revertLegend = function() {
        var t = this,
          e = t.d3;
        t.legend
          .selectAll("." + Y.legendItem)
      ...
      (u.prototype.showLegend = function(t) {
        var e = this,
          i = e.config;
        i.legend_show ||
          ((i.legend_show = !0),
      ...
      (u.prototype.hideLegend = function(t) {
        var e = this,
          i = e.config;
        i.legend_show &&
          l(t) &&
      ...
      (u.prototype.clearLegendItemTextBoxCache = function() {
        this.legendItemTextBox = {};
      }),
      (u.prototype.updateLegend = function(f, t, e) {
        var i,
          n,
          r,
          a,
      ...
      (u.prototype.redrawRegion = function(t, e) {
        var i = this,
          n = i.mainRegion;
        return [
          (t ? n.transition(e) : n)
      ...
      (u.prototype.regionX = function(t) {
        var e = this,
          i = e.config,
          n = "y" === t.axis ? e.y : e.y2;
        return "y" === t.axis || "y2" === t.axis
          ? i.axis_rotated && "start" in t ? n(t.start) : 0
          : i.axis_rotated
            ? 0
            : "start" in t
      ...
      (u.prototype.regionY = function(t) {
        var e = this,
          i = e.config,
          n = "y" === t.axis ? e.y : e.y2;
        return "y" === t.axis || "y2" === t.axis
          ? i.axis_rotated ? 0 : "end" in t ? n(t.end) : 0
          : i.axis_rotated && "start" in t
            ? e.x(e.isTimeSeries() ? e.parseDate(t.start) : t.start)
            : 0;
      }),
      (u.prototype.regionWidth = function(t) {
        var e,
          i = this,
          n = i.config,
          r = i.regionX(t),
        ...
        return (e =
          "y" === t.axis || "y2" === t.axis
            ? n.axis_rotated && "end" in t ? a(t.end) : i.width
            : n.axis_rotated
              ? i.width
              : "end" in t
      ...
      (u.prototype.regionHeight = function(t) {
        var e,
          i = this,
          n = i.config,
          r = this.regionY(t),
        ...
        return (e =
          "y" === t.axis || "y2" === t.axis
            ? n.axis_rotated ? i.height : "start" in t ? a(t.start) : i.height
      ...
      (u.prototype.isRegionOnX = function(t) {
        return !t.axis || "x" === t.axis;
      }),
      (u.prototype.getScale = function(t, e, i) {
        return (i ? this.d3.scaleTime() : this.d3.scaleLinear()).range([t, e]);
      }),
      (u.prototype.getX = function(t, e, i, n) {
        var r,
      ...
      (u.prototype.selectPoint = function(t, e, i) {
        var n = this,
          r = n.config,
      ...
      (u.prototype.unselectPoint = function(t, e, i) {
      ...
      (u.prototype.togglePoint = function(t, e, i, n) {
        t ? this.selectPoint(e, i, n) : this.unselectPoint(e, i, n);
      }),
      (u.prototype.selectPath = function(t, e) {
        var i = this;
      ...
      (u.prototype.unselectPath = function(t, e) {
        var i = this;
      ...
      (u.prototype.togglePath = function(t, e, i, n) {
        t ? this.selectPath(e, i, n) : this.unselectPath(e, i, n);
      }),
      (u.prototype.getToggle = function(t, e) {
        var i;
        return (
          "circle" === t.nodeName
      ...
      (u.prototype.toggleShape = function(t, e, i) {
        var n = this,
          r = n.d3,
          a = n.config,
          o = r.select(t),
      ...
      (u.prototype.initBar = function() {
        this.main
          .select("." + Y.chart)
          .append("g")
          .attr("class", Y.chartBars);
      }),
      (u.prototype.updateTargetsForBar = function(t) {
        var e = this,
          i = e.config,
      ...
      (u.prototype.updateBar = function(t) {
        var e = this,
          i = e.barData.bind(e),
          n = e.classBar.bind(e),
      ...
      (u.prototype.redrawBar = function(t, e, i) {
        return [
      ...
      (u.prototype.generateGetBarPoints = function(t, e) {
        var o = this,
          ...
          d = o.getShapeY(!!e),
          u = o.getShapeOffset(o.isBarType, t, !!e),
          l = s * (o.config.bar_space / 2),
      ...
      (u.prototype.isWithinBar = function(t, e) {
      ...
      (u.prototype.getShapeIndices = function(t) {
        var e,
          i,
          n = this.config,
          r = {},
      ...
      (u.prototype.getShapeX = function(i, n, r, t) {
      ...
      (u.prototype.getShapeY = function(e) {
        var i = this;
        return function(t) {
          return (e ? i.getSubYScale(t.id) : i.getYScale(t.id))(t.value);
        };
      }),
      (u.prototype.getShapeOffset = function(t, s, e) {
        var c = this,
      ...
      (u.prototype.isWithinShape = function(t, e) {
        var i,
          n = this,
          r = n.d3.select(t);
        return (
      ...
      (u.prototype.getInterpolate = function(t) {
        var e = this,
          i = e.d3,
          n = {
        ...
        return e.isSplineType(t)
          ...
          : e.isStepType(t) ? n[e.config.line_step_type] : n.linear;
      }),
      (u.prototype.initLine = function() {
        this.main
          .select("." + Y.chart)
          .append("g")
          .attr("class", Y.chartLines);
      }),
      (u.prototype.updateTargetsForLine = function(t) {
        var e,
          i = this,
          n = i.config,
      ...
      (u.prototype.updateLine = function(t) {
        var e = this,
          i = e.main
            .selectAll("." + Y.lines)
            .selectAll("." + Y.line)
      ...
      (u.prototype.redrawLine = function(t, e, i) {
        return [
      ...
      (u.prototype.generateDrawLine = function(t, s) {
        var c = this,
          d = c.config,
          u = c.d3.line(),
          i = c.generateGetLinePoints(t, s),
          l = s ? c.getSubYScale : c.getYScale,
          e = function(t) {
            ...
            return (
              c.isLineType(t)
                ? d.data_regions[t.id]
                  ...
                  : (c.isStepType(t) && (i = c.convertValuesToStep(i)),
                    (e = u.curve(c.getInterpolate(t))(i)))
                : (i[0] && ((a = n(i[0].x)), (o = r(i[0].value))),
                  (e = d.axis_rotated ? "M " + o + " " + a : "M " + a + " " + o)),
              e || "M 0 0"
            );
          }
        );
      }),
      (u.prototype.generateGetLinePoints = function(t, e) {
        var o = this,
          s = o.config,
          i = t.__max__ + 1,
          c = o.getShapeX(0, i, t, !!e),
          d = o.getShapeY(!!e),
          u = o.getShapeOffset(o.isLineType, t, !!e),
          l = e ? o.getSubYScale : o.getYScale;
        return function(t, e) {
          var i = l.call(o, t.id)(0),
            n = u(t, e) || i,
            r = c(t),
            a = d(t);
          return (
      ...
      (u.prototype.lineWithRegions = function(t, c, d, e) {
        var i,
          n,
          r,
          a,
          ...
          g = _.axis_rotated
            ...
            r = f.isTimeSeries()
              ? function(t, e, i, n) {
                  ...
                  return w(
                    _.axis_rotated
                      ? [[d(u(i)), c(o)], [d(u(i + n)), c(s)]]
                      : [[c(o), d(u(i))], [c(s), d(u(i + n))]]
                  );
                }
              : function(t, e, i, n) {
                  return w(
                    _.axis_rotated
                      ? [[d(u(i), !0), c(a(i))], [d(u(i + n), !0), c(a(i + n))]]
                      : [[c(a(i), !0), d(u(i))], [c(a(i + n), !0), d(u(i + n))]]
                  );
                },
            i = 0;
          i < t.length;
          ...
          if (v(m) || !S(t[i].x, m)) x += " " + g(t[i]) + " " + p(t[i]);
            ...
            for (
              a = f.getScale(t[i - 1].x + y, t[i].x + y, f.isTimeSeries()),
                ...
                h = 2 * (l = 2 / Math.sqrt(Math.pow(o, 2) + Math.pow(s, 2))),
                n = l;
              n <= 1;
              n += h
            )
      ...
      (u.prototype.updateArea = function(t) {
        var e = this,
          i = e.d3,
          n = e.main
            .selectAll("." + Y.areas)
      ...
      (u.prototype.redrawArea = function(t, e, i) {
        return [
      ...
      (u.prototype.generateDrawArea = function(t, e) {
        var a = this,
          o = a.config,
          s = a.d3.area(),
          ...
          c = function(t, e) {
            return 0 < o.data_groups.length
              ? i(t, e)[0][1]
              : n.call(a, t.id)(a.getAreaBaseValue(t.id));
          },
          d = function(t, e) {
            return 0 < o.data_groups.length
              ? i(t, e)[1][1]
              : n.call(a, t.id)(t.value);
          };
        return (
          (s = o.axis_rotated
            ? s
          ...
          function(t) {
            var e,
              i = o.line_connectNull ? a.filterRemoveNull(t.values) : t.values,
              n = 0,
              r = 0;
            return (
              a.isAreaType(t)
                ? (a.isStepType(t) && (i = a.convertValuesToStep(i)),
                  (e = s.curve(a.getInterpolate(t))(i)))
                : (i[0] &&
                    ((n = a.x(i[0].x)), (r = a.getYScale(t.id)(i[0].value))),
                  (e = o.axis_rotated ? "M " + r + " " + n : "M " + n + " " + r)),
              e || "M 0 0"
            );
          }
        );
      }),
      (u.prototype.getAreaBaseValue = function() {
        return 0;
      }),
      (u.prototype.generateGetAreaPoints = function(t, e) {
        var o = this,
          s = o.config,
          i = t.__max__ + 1,
          c = o.getShapeX(0, i, t, !!e),
      ...
      (u.prototype.updateCircle = function(t, e) {
        var i = this,
          n = i.main
            .selectAll("." + Y.circles)
            .selectAll("." + Y.circle)
      ...
      (u.prototype.redrawCircle = function(t, e, i, n) {
        var r = this,
      ...
      (u.prototype.circleX = function(t) {
        return t.x || 0 === t.x ? this.x(t.x) : null;
      }),
      (u.prototype.updateCircleY = function() {
        var t,
          i,
          e = this;
      ...
      (u.prototype.getCircles = function(t, e) {
        return (e
          ? this.main.selectAll("." + Y.circles + this.getTargetSelectorSuffix(e))
          : this.main
        ).selectAll("." + Y.circle + (P(t) ? "-" + t : ""));
      }),
      (u.prototype.expandCircles = function(t, e, i) {
      ...
      (u.prototype.unexpandCircles = function(t) {
        var e = this,
          i = e.pointR.bind(e);
        e
          .getCircles(t)
      ...
      (u.prototype.pointR = function(t) {
        var e = this.config;
        return this.isStepType(t) ? 0 : h(e.point_r) ? e.point_r(t) : e.point_r;
      }),
      (u.prototype.pointExpandedR = function(t) {
        var e = this.config;
      ...
      (u.prototype.pointSelectR = function(t) {
        var e = this.config;
        return h(e.point_select_r)
          ? e.point_select_r(t)
          : e.point_select_r ? e.point_select_r : 4 * this.pointR(t);
      }),
      (u.prototype.isWithinCircle = function(t, e) {
        var i = this.d3,
          n = i.mouse(t),
          r = i.select(t),
          a = +r.attr("cx"),
      ...
      (u.prototype.isWithinStep = function(t, e) {
        return Math.abs(e - this.d3.mouse(t)[1]) < 30;
      }),
      (u.prototype.getCurrentWidth = function() {
        var t = this.config;
        return t.size_width ? t.size_width : this.getParentWidth();
      }),
      (u.prototype.getCurrentHeight = function() {
        var t = this.config,
      ...
      (u.prototype.getCurrentPaddingTop = function() {
        var t = this.config,
      ...
      (u.prototype.getCurrentPaddingBottom = function() {
        var t = this.config;
        return P(t.padding_bottom) ? t.padding_bottom : 0;
      }),
      (u.prototype.getCurrentPaddingLeft = function(t) {
        var e = this.config;
        return P(e.padding_left)
          ...
          : e.axis_rotated
            ...
            : !e.axis_y_show || e.axis_y_inner
              ? this.axis.getYAxisLabelPosition().isOuter ? 30 : 1
              : r(this.getAxisWidthByAxisId("y", t));
      }),
      (u.prototype.getCurrentPaddingRight = function() {
        var t = this,
          e = t.config,
      ...
      (u.prototype.getParentRectValue = function(e) {
      ...
      (u.prototype.getParentWidth = function() {
        return this.getParentRectValue("width");
      }),
      (u.prototype.getParentHeight = function() {
        var t = this.selectChart.style("height");
        return 0 < t.indexOf("px") ? +t.replace("px", "") : 0;
      }),
      (u.prototype.getSvgLeft = function(t) {
        var e = this,
          i = e.config,
      ...
      (u.prototype.getAxisWidthByAxisId = function(t, e) {
        var i = this.axis.getLabelPositionById(t);
        return this.axis.getMaxTickWidth(t, e) + (i.isInner ? 20 : 40);
      }),
      (u.prototype.getHorizontalAxisHeight = function(t) {
        var e = this,
          i = e.config,
          n = 30;
        return "x" !== t || i.axis_x_show
          ? "x" === t && i.axis_x_height
            ...
            : "y" !== t || i.axis_y_show
              ...
              : !i.legend_show || e.isLegendRight || e.isLegendInset ? 1 : 10
          : 8;
      }),
      (u.prototype.initBrush = function(t) {
        var r = this,
          e = r.d3;
        return (
      ...
      (u.prototype.initSubchart = function() {
        var t = this,
          e = t.config,
          i = (t.context = t.svg
            .append("g")
      ...
      (u.prototype.initSubchartBrush = function() {
        this.initBrush(this.subX).updateExtent(),
          this.context.select("." + Y.brush).call(this.brush);
      }),
      (u.prototype.updateTargetsForSubchart = function(t) {
        var e,
          i,
          n,
          r,
          ...
          u = a.classChartLine.bind(a),
          l = a.classLines.bind(a),
      ...
      (u.prototype.updateBarForSubchart = function(t) {
        var e = this,
          i = e.context
            .selectAll("." + Y.bars)
            .selectAll("." + Y.bar)
      ...
      (u.prototype.redrawBarForSubchart = function(t, e, i) {
        (e
      ...
      (u.prototype.updateLineForSubchart = function(t) {
        var e = this,
          i = e.context
            .selectAll("." + Y.lines)
            .selectAll("." + Y.line)
      ...
      (u.prototype.redrawLineForSubchart = function(t, e, i) {
        (e
      ...
      (u.prototype.updateAreaForSubchart = function(t) {
        var e = this,
          i = e.d3,
          n = e.context
            .selectAll("." + Y.areas)
      ...
      (u.prototype.redrawAreaForSubchart = function(t, e, i) {
        (e
      ...
      (u.prototype.redrawSubchart = function(t, e, i, n, r, a, o) {
        var s,
          c,
          d,
          u = this,
        ...
        u.context.style("visibility", h.subchart_show ? "visible" : "hidden"),
          h.subchart_show &&
            ...
            t &&
              ...
              (s = u.generateDrawArea(r, !0)),
              (c = u.generateDrawBar(a, !0)),
              (d = u.generateDrawLine(o, !0)),
              ...
              u.redrawAreaForSubchart(s, i, i)));
      }),
      (u.prototype.redrawForBrush = function() {
        var t,
          e = this,
          i = e.x,
          n = e.d3;
      ...
      (u.prototype.transformContext = function(t, e) {
        var i;
        e && e.axisSubX
          ? (i = e.axisSubX)
      ...
      (u.prototype.getDefaultSelection = function() {
        var t = this,
          e = t.config,
      ...
      (u.prototype.updateTargetsForText = function(t) {
        var e = this,
      ...
      (u.prototype.updateText = function(t, e, i) {
        var n = this,
          r = n.config,
      ...
      (u.prototype.redrawText = function(t, e, i, n, r) {
        return [
      ...
      (u.prototype.getTextRect = function(t, e, i) {
        var n,
          r = this.d3
            .select("body")
            .append("div")
      ...
      (u.prototype.generateXYForText = function(t, e, i, n) {
        var r = this,
      ...
      (u.prototype.getXForText = function(t, e, i) {
        var n,
          r,
          a = this,
      ...
      (u.prototype.getYForText = function(t, e, i) {
        var n,
          r = this,
      ...
      (u.prototype.yForTitle = function() {
        var t = this;
        return (
      ...
      (u.prototype.getTitlePadding = function() {
        return this.yForTitle() + this.config.title_padding.bottom;
      }),
      (u.prototype.initTooltip = function() {
        var t,
          e = this,
          i = e.config;
        if (
      ...
      (u.prototype.getTooltipSortFunction = function() {
        var t = this,
          e = t.config;
      ...
      (u.prototype.getTooltipContent = function(t, e, i, n) {
        var r,
          a,
          o,
          s,
        ...
        for (f && t.sort(f), a = 0; a < t.length; a++)
          if (
            ...
            (c = _(g(t[a].name, t[a].ratio, t[a].id, t[a].index))),
              (d = u.levelColor ? u.levelColor(t[a].value) : n(t[a].id)),
              (r +=
                "<tr class='" +
                u.CLASS.tooltipName +
                "-" +
                u.getTargetSelectorSuffix(t[a].id) +
                "'>"),
              (r +=
      ...
      (u.prototype.tooltipPosition = function(t, e, i, n) {
        var r,
          a,
          o,
          s,
      ...
      (u.prototype.showTooltip = function(t, e) {
        var i,
          n,
          r,
          a = this,
          ...
          d = o.tooltip_position || u.prototype.tooltipPosition;
        0 !== c.length &&
          o.tooltip_show &&
          (a.tooltip
            .html(
      ...
      (u.prototype.setTargetType = function(t, e) {
        var i = this,
          n = i.config;
      ...
      (u.prototype.hasType = function(i, t) {
      ...
      (u.prototype.hasArcType = function(t) {
        return (
          this.hasType("pie", t) ||
      ...
      (u.prototype.isLineType = function(t) {
        var e = this.config,
          i = c(t) ? t : t.id;
        return (
          !e.data_types[i] ||
          ...
          (i.zoom.updateExtent = function() {
            return (
              this.scaleExtent([1, 1 / 0])
                .translateExtent([[0, 0], [i.width, i.height]])
      ...
      (u.prototype.redrawForZoom = function() {
        var t = this,
          e = t.d3,
          i = t.config,
          n = t.zoom,
        ...
        i.zoom_enabled &&
          ...
          e.event.sourceEvent &&
            ...
            (t.cancelClick = !0),
          i.zoom_onzoom.call(t.api, r.orgDomain()));
      }),
      t
    );
  });
