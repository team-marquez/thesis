...
class Onboarding extends React.Component {
  ...
  fillOnboardingArray = this.fillOnboardingArray.bind(this);
  showFirst = this.showFirst.bind(this);
  showSecond = this.showSecond.bind(this);
  showThird = this.showThird.bind(this);
  showFourth = this.showFourth.bind(this);
  showFifth = this.showFifth.bind(this);
  showSixth = this.showSixth.bind(this);
  submitAnswers = this.submitAnswers.bind(this);
  closeSixth = this.closeSixth.bind(this);
  ...
  showSecond() {
    this.setState(
      { showFirst: false, showSecond: true, optionSelected: false },
      this.saveSelected()
    );
  }
  showThird() {
    this.setState(
      { showSecond: false, showThird: true, optionSelected: false },
      this.saveSelected()
    );
  }
  showFourth() {
    this.setState(
      { showThird: false, showFourth: true, optionSelected: false },
      this.saveSelected()
    );
  }
  showFifth() {
    this.setState(
      { showFourth: false, showFifth: true, optionSelected: false },
      this.saveSelected()
    );
  }
  showSixth() {
    this.setState(
      { showFifth: false, showSixth: true, optionSelected: false },
      this.saveSelected()
    );
  }
  closeSixth() {
    this.setState(
      { showSixth: false, showClosing: true, optionSelected: false },
      this.saveSelected()
    );
  }
  submitAnswers() {
